...
items, by several factors. We find that by factoring in recentness, price and
popularity-trends for each user, we achieve a set of generated ratings that
combined, generally outperforms all other feature alone. These promising
results, coupled with a robust, modular and highly adaptive system for making
recommendations from implicit feedback promotes further research into the area.
\end{abstract}
\pagenumbering{roman}
