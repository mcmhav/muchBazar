...
\usepackage[british]{babel} % break words when going over a line.
\usepackage{caption}
...
\usepackage{amssymb}
\usepackage{catchfilebetweentags} % fetch equations from separate file
%\usepackage[dvipsnames]{xcolor}

% equation shortcuts
\newcommand{\equationMEA}{
  \ExecuteMetaData[equations.tex]{mea}}
\newcommand{\equationRMSE}{
  \ExecuteMetaData[equations.tex]{rmse}}
\newcommand{\equationDCG}{
  \ExecuteMetaData[equations.tex]{dcg}}
\newcommand{\equationNDCG}{
  \ExecuteMetaData[equations.tex]{ndcg}}
...
\input{\ChaptersPath/03-implementation}
\input{\ChaptersPath/04-evaluation}
\input{\ChaptersPath/05-conclusion}
