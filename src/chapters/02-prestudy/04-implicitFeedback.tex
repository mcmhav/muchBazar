...
\begin{table}[H]
    ...
    \textit{Meaning}
                       ...
                       & Indicates confidence. %TODO Helge: ? Higher frequency in implicit 
...
%TODO - {Helge: Maybe best in plain text?}
...
Model 2: $r_{iu} = w_characterisation0 + w_1 if_{iu} + w_2 re_{iu}$ \\
