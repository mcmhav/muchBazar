...
\textbf{Weighted low rank approximation. \marginpar{cite}}
...
With these two matrices, weighted low rank approximation is meant to find a low rank matrix $X$, which minimizes the objective of a weighted Frobenius loss function. \marginpar{reread}
...
\textbf{Negative example sampling \marginpar{cite}.}
...
\textbf{Em algorithms to predict negative examples \marginpar{ref}.}
\marginpar{check out the approaches}
PEBL: positive example based learning for web page classification using SVM
Building text classifiers using positive and unlabeled examples
Presence-only data and the EM algorithm

\textbf{Low-density non-negative matrix factorization (ldNMF).~\marginpar{cite}}
arg min
J W, H, {y ij } (i,j)∈U =
W ≥0,H≥0
y ij ∈{0,1},(i,j)∈U
...
\textbf{Group Bayesian personalized ranking (GBPR).~\marginpar{cite}}
...
\textbf{Incorporating Rich User Information. \marginpar{cite}}
