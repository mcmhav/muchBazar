...
% \begin{itemize}
%   \item Concrete Attributes (product features)
%   \begin{itemize}
%     \item Intrinsic (hedonic)
%     \begin{itemize}
%       \item Aesthetics
%       \begin{itemize}
%         \item Style
...
%       \item Place(Store)
%       \item Salespeson's evaluation
%       \item Approval of others
%       \item Coordination with wardrobe
%     \end{itemize}
%   \end{itemize}
%   \item Abstract Attributes (attitude-based)
%   \begin{itemize}
%     \item Fun
%     \item Entertainment
%     \item Enjoyment
...
% The common consumer goes through a set of stages when consuming a product.
% First the stage is the need.
% The need can come from a variety of stimuli.
% This need can be segmented into two subsections:
% The internal stimuli and the external stimuli.
% The internal can be thirst, hunger, feeling tired or has personal interest.
% The external can be commercial or other people.
% When the need is recognized the consumer does an information search and evaluates the product with similar product, which can lead to
