...
%TODO - Discussion on suitedness of implicit ratings for entropy calculations

%TODO - Scalability - Good?
...
%	What kind of bots could we use?
%TODO - Scalability
	%Good scalability (Minimal/Negligent according to the authors, when using 7 bots)
...
%TODO - Summarize results
%TODO - How can we implement this in our system?
%			What about user factors? (Facebook)
%			What about item factors? (Item-database)
...
%TODO - Table with score (1-5 stars) rating the following properties
%			Accuracy, Cold-start performance, Scalability...
%TODO - Our proposal
