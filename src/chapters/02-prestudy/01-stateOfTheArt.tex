...
>>>>>>> d939115f7a8b1c2874aa51cf22a2718f98f4f648
...
\begin{table}[H]
    \centering
    \begin{tabular}{l|l|l}
      \textbf{Schemes} \todo{correct?}       & \textbf{Pos Examples} & \textbf{Neg Examples} \\ \hline
      ...
      User-Item interaction & $W_{ij} = 1$ & $W_{ij} = 1$ \todo{fixequations} \\
    \end{tabular}
    \label{table:WeightingSchemes}
    \caption [Weighting Schemes]{Different ways of weighting ratings suggested by~\todo{add cite}}
\end{table}
