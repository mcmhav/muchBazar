...
>>>>>>> 34895417455007ae8fd830a338931cf14af2853f
...
%	How good results? Summarize the results
%	Scalability
%	Tables comparing the different approaces
%		Accuracy
%		User effort
%		Scalability
%		Suitedness for online recommenders
%	How can we apply these methods in our "situation"?
...
%Expressing trust requires user a pretty high degree of user effort, since they need to determine what users they trust
...
%TODO - Check out their article, key figures in trust-aware recommender. Good solution to new user problem for trust?
%E.g recommendations based on the most followed users (Kinda like popularity)
...
% How does this compare to e.g. most followed/trusted users?
% A bit to simplistic... i dont really like having to rate all representative items and EVEN MORE not that all the representative users have to rate all new items in order for them to be folded in -> "Full time job in our case"
