...
\paragraph{Weighted low rank approximation.} % \todo{cite}}
...
\paragraph{Negative example sampling }% \todo{cite}.}
...
\paragraph{Em algorithms to predict negative examples} % \todo{ref}.}
% \todo{check out the approaches}
PEBL: positive example based learning for web page classification using SVM
Building text classifiers using positive and unlabeled examples
Presence-only data and the EM algorithm

\paragraph{Low-density non-negative matrix factorization (ldNMF).}~% \todo{cite}}
arg min
J W, H, {y ij } (i,j)∈U =
W ≥0,H≥0
y ij ∈{0,1},(i,j)∈U
...
\paragraph{Group Bayesian personalized ranking (GBPR).}~% \todo{cite}}
...
\paragraph{Incorporating Rich User Information. }% \todo{cite}}
