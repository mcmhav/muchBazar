...
The main reasons we chose to experiment with filterbots is the simplicity, the fact that it easily could
...
\marginpar{Interesting to see how filterbots affect ALS-WR, as it was originally developed for traditional collaborative filtering}
