...
\subsection{User properties}
    ...
    \end{figure}
        ...
        After having looked at the distribution of events per user, we move over to the user account lifetime, to see actually how long a user is active on the application in terms of time from first to last recorded event for the user.
