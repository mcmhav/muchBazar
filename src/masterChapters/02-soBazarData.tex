...
\section{Graphs}
    ...
    % \end{figure}
	\marginpar{TODO: change x and y labels?}
    \begin{figure}[H]
	...
	\marginpar{Long tail vs Pareto principle}
	    ...
	    Long tail: the most frequent-occurring items represent less than 50\% of the occurrences in the logs.
    ...
    \begin{figure}[H]
        \includegraphics[width=5in]{image/product_wanteddistribution.png}
        \centering
    ...
    \begin{figure}[H]
        \includegraphics[width=5in]{image/product_purchase_intendeddistribution.png}
        \centering
