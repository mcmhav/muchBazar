...
\subsubsection{Long tail and the Pareto principle on sales}
    The Figure~\ref{figure:eventsPerproduct}
    As seen from most of the product properties graphs they have a categorical shape, the long tailed shape?
    A little something something about the two .... general something
    why text here?

\paragraph{Pareto's Principle}
    Something more about it here?
    For a given distribution such as sales of a catalog of items, when the Pareto principle applies, the first 20\% of the products hits account for 80\% of sales.
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{lll}
        \toprule
        Threshold &   Products in threshold~\tablefootnote{The amount of products} &      Percentage of ratings \\
        \midrule
        20.0    &    1206   &    59.1701 \\
        40.0    &    2411   &    79.5309 \\
        50.0    &    3014   &    86.0226 \\
    ...
    Our numbers, what does they mean?

\paragraph{Long Tail}
    Something about tail here
