...
with an item view price average between $x$ to $x+99$. The first bucket for
instance contains the users with average item view price between $0$ and $99$.

As we can see from the figure above the users are centered around $300$, where
$300$ is the most common interaction price~\footnote{The median price is $299$}.
