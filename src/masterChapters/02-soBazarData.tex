...
\subsection{Time properties}
    ...
    \end{figure}
        ...
        The figures above presented the actions \emph{purchase} and \emph{want}, the next figure presents the \emph{bounce rate}, or how fast the user on average went sdf
    \begin{figure}[H]
