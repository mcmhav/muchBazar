...
Rec 4				& -		 & - 	  & - 	   & - 		& - 	 & - 	  & -	   & -		& - 	 & 	   	  & -	   &		&	   &	  &		 &		&	   & - 							\\ \hline
\end{tabular}
\caption{Sobazar Cold-start System Evaluation Results using Implicit Ratings (count_sigmoid_fixed_sr-3.5.txt)}
\end{table}
...
Rec 4				& -		 & - 	  & - 	   & - 		& - 	 & - 	  & -	   & -		& - 	 & 	   	  & -	   &		&	   &	  &		 &		&	   & - 							\\ \hline
\end{tabular}
\caption{Sobazar Cold-start Item Evaluation Results using Implicit Ratings (count_sigmoid_fixed_sr-3.5.txt)}
\end{table}
...
Rec 4				& -		 & - 	  & - 	   & - 		& - 	 & - 	  & -	   & -		& - 	 & 	   	  & -	   &		&	   &	  &		 &		&	   & - 							\\ \hline
\end{tabular}
\caption{Sobazar Cold-start User Evaluation Results using Implicit Ratings (count_sigmoid_fixed_sr-3.5.txt)}
\end{table}
