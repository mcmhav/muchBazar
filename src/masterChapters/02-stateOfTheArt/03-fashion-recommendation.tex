...
\subsubsection{What is fashion.}
  ...
  % mtodo musikk, hår, utddemls, restauranter/mat, film, dingers....
  % mtodo mote definisjon bør inneholde noe med "uniformeing"/måte å bli del av/vise tilhørighet til ei gruppe? "elitisme" Deretter: dere ser på subset: klær
...
\subsubsection{Task of fashion marketing.}
  ...
  \begin{table}[H]
      \centering
      \begin{tabular}{l|l}
        \emph{Factors}        & \emph{Examples} \\ \hline
...
% mtodo - hvorfor er det sånn? (=> ønsker at leser skal forstå markeds-mekanismene og dermed kan få en feel for hvorfor dette er vansklig/spesielt domene)
...
\subsection{Fashion in E-commerce}
  ...
  % mtodo - Sentrale problemer når vi kommer hit virker å være
    % - vi "frarøver" moteløver kjøpeopplevelsen/eksklusivitet i buttikk etc. (apple-store)
    % - Muligheten til å vurdere "instrinc attibuter" (2.7)
    % - Omløpshastighet avtar (postgasete)
    % Hvorfor kan soBazar e.l. lykkes?
...
\subsection{SoBazar, the e-commerce application}
    % mtodo - about sobazar, what is it?
...
\label{par:myntra}
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{l|l}
            ...
            \pbox{9cm}{
                - Suggest similar items connected to the currently viewed \\
...
\label{par:flink}
    ...
    \end{table}
  % mtodo - might be more, but can't explore the application since it is iOS 7 required
% paragraph flink (end)
    ...
    \begin{table}[H]
        ...
        \begin{tabular}{l|l}
            ...
            \pbox{9cm}{
                ...
                - Manual/limited personalized recommendations \\
            } \\ \bottomrule
        \end{tabular}
...
% mtodo - her har vi vist skiftet fokus litt mot mer "user interaction" og "barns for anbefalinger"
