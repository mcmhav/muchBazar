...
\subsection{Fashion in E-commerce}
  ...
  \begin{figure}[H]
      \includegraphics[width=5in]{image/ecommerceConsumptionDevelopment.png}
      \centering
      \caption[Statistics of e-commerce purchase in Norway]{This figure is taken from~\cite{statisticsNorway} and shows the increase in purchase through e-commerce applications in Norway in percentage. The red line is for men, the yellow is for women and the blue is for both.}
  \end{figure}
