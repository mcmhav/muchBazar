...
This section shows the detailed results for all experimental including all the evaluation metrics
measured and different parameter settings. The following table shows a few runs from a 90:10 timesplit on the data.
As you can see the table only contains two purchase events which accounts for 0.07\% of the events in the testset.
...
\label{appendix:tab9010-timesplits}
\end{table}

The following table shows all experimental results for our 80:20 time-split on the data. The table contains all experimental runs and evaluation metrics used
in addition to the parameter settings used.
...
ItemBasedKNN k=50       & 0.418569 &  0.004367 &  3038 &  2328 &  36 &  12 &  9  &  2 & 0.00395  &  0.003866 &  0.055556 &  0.003914 &  0.002017 &  0.014286 &   \\
...
All experiments with implicit ratings have an extended name such as e.g. Count, which is the name of the implicit rating function used. The table highlights the bad
performance of traditional collaborative filtering algorithms on our implicit ratings, in particular in terms of AUC score.
The following table shows the averages of all experimental results generated doing 80:20 random splits on the dataset.
...
All method names extended with e.g. Count or Price are results generated from our implicit ratings and is the name of the implicit rating function used.
...
%%ALS-WR 0 0 0 0 0
%system-40 & 0.548979 &  0.00113 &   2102 &  2545 &  745 &   3.25 &  4.75 &  0.375 & 0.001546 &  0.001866 &  0.000503 &  0.000709 &  0.001837 &  0.000135 &   \\
...
%system-80 & 0.569449 &  0.00222 &   2102 &  2545 &  745 &   5.25 &  9.125 & 0.625 & 0.002498 &  0.003585 &  0.000839 &  0.001118 &  0.00824 &   0.000562 &   \\
