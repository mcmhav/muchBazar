...
In Figure~\ref{fig:aucroc} three ROC curves have been plotted. As mentioned earlier, the blue line represent a set of true random guesses, resulting in a $AUROC$ of $0.5$. The red and green lines are performing better than the blue line in sense of $AUROC$, and has therefore a larger area under their curves, where the green is performing the best.
