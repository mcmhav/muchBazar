...
\begin{itemize}
    \item Accuracy: How accurate is the system overall?
...
Intelligent selection, Filterbots and Trust-aware RS have not been given an accuracy score as it is not a recommender system in itself. Trust-aware recommender systems get a \ding{55} in user effort as it is hard to find users to connect to,
...
could provide us with a sufficiently good solution to the cold-start problem. However, the hybrid methods are both dependent on good user and item features.
