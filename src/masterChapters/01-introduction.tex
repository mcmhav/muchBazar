...
\begin{itemize}
 	\item G4: What solutions exists, what can be used
	\item G5: How can the different event types be combined into \emph{implicit ratings}?
  	\item G6: How can we evaluate the implicit ratings generated from implicit feedback?
 	\item G7: Establish user interaction patterns to better evaluate.
\end{itemize}
