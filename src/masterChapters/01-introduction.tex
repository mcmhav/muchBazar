...
\section{System Overview}
  ...
  \paragraph{The limitations} of this thesis are primary linked to having
  only one available dataset with both sparse and modest data. As a result,
  making conclusions based user behavior proved difficult due to lack of
  statistical significance on many observations. Limitations in both time
