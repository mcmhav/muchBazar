...
% E.g. Due to data limitations we have excluded cold-start articles looking at
% how demographic data can be incorporated to solve the cold-start user problem.
