...
\marginpar{heri-notes: Motivating example ville være nyttig for å få leseren til å forstå bedre tankegangen}

\section{Problem Statement and Goals}

\marginpar{heri-notes: overordnet problemstilling}
%Problem statement
...
\marginpar{heri-notes: scope, what this thesis is not about, limitations}
...
\section{System Overview}
  ...
  \marginpar{Hai said: Maybe remove the evaluate recommender box?}
  \marginpar{If filterbots makes it to the 'final system', include it in a more detailed system 'drawing'?}
  
  
  The following figure shows an overview of the process from data collection to recommendations.
  \marginpar{Extend introduction with ref to the chapters/section the boxes are referring to}
  ...
  \begin{center}
    \begin{tikzpicture}
      ...
      \node [comment, right=0.25 of inputData] (comment-inputData) {
        Feedback gathered from the SoBazaar application data dump
      };
