...
\newcommand{\ecommercenorway}[0]{
  \begin{figure}[H]
    ...
    \caption{E-commerce purchases in Norway since 2005}
  \end{figure}
}
...
\begin{itemize}
  ...
  \item G7: Identify different methods of combining various event types into
  \emph{implicit ratings}.
  \item G8: Find metrics in order to evaluate the \emph{implicit ratings}.
\end{itemize}
