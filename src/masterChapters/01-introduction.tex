...
\section{System Overview}
  \begin{center}
    \begin{tikzpicture}
      ...
      \centering
      % Draw forces
      \node [force] (inputData) {Input data based on implicit feedback (events)};
      \node [force, below of=inputData] (implicitConverter) {Convert implicit feedback to implicit ratings};
      \node [force, below of=implicitConverter] (ratings) {Ratings for the items};
      \node [force, below of=ratings] (recommendations) {Make recommendations};
      \node [force, below of=recommendations] (evaluations) {Evaluate recommendations};
      ...
      \node [comment, right=0.25 of recommendations] (comment-recommendations) {
        Makes recommendations based on the inputed ratings. Different approaches to make the recommendations can be take, such as matrix factorization
      };
    ...
    \end{tikzpicture}
    \captionof{figure}[System Overview]{Overview of the system}
  \end{center}
