...
%which basicly boils every user and item down to a set of factors and ulility
%values for these factors.

%Ideally the recommender system should be able to utilize all the information collected
	%Social information
	%Content-information
	%Log-data
		%Traditional collaborative filtering
			%Recentness and other factors
	%Demographic information
%we have only touched on a small part of the possibilities. There is much work to be done. 
