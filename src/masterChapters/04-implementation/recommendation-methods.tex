...
felt that the lack of high quality features was a limiting factor when designing the filterbots, as there is only so much information in the rating matrix.
