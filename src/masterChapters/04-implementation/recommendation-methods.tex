...
product database and be assigned features. The following table shows an overview of how our feature
extractor were to extract the different features for these items:
