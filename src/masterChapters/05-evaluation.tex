...
%TODO - more?
	...
	% mtodo - så poenget her er å finne robusthet av en estimator (som regel...)
...
With these averages a histogram can be produced, which provides an estimate of the distribution of this average.
	...
	% mtodo - check this chapter again
\paragraph{Disadvantages}
...
Other evaluation methods worth knowing about includes confidence, trust, utility, robustness, adaptivity, scalability mentioned in \cite{Herlocker2004, Shani2011}.
	...
	%mtodo - hvordan konvertere implicit til explicit
...
Two ways of measuring the system is through ranking and usage prediction described earlier.
  ...
  \begin{center}
    ...
    \end{tikzpicture}
    \captionof{figure}[Implicit Rating Evaluation]{Overview of how the generated ratings can be evaluated.}
  \end{center}

  % mtodo - write some sick notes to this shit
...
\marginpar{move offline beyond accuracy to here maybe? }
	...
	%mtodo - plain bucket-test virker mest logisk:
		% system A - 1000.0 brukere -> omsetning for telenor
		% system B - 1000.0 brukere -> omsetning for telenor
		% si noe om dette
