...
mentioned this was in our experiments set to $0.5$. By using the same
methodology as in earlier features, we apply the found penalization and
normalize the obtained score to ratings - yielding the following distribution:

\begin{figure}[H]
  \centering
  \includegraphics[scale=0.5]{image/dist-popularity}
  \caption{Distribution considering item popularity and the users conformity to
  popular items}
