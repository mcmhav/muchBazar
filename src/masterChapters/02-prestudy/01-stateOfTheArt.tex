...
quality is most likely bound to suffer.
...
calculations}. We are also currently constrained to unobtrusively learn
...
% \subsubsection{How To Model}
%     How to use the gathered information to model the user.
%     Event features:
%         - Amount of purchases
%         - Amount of views
%         - Amount of wants
%         - Time on items under the different conditions mentioned above
%         - What was done before a specific action
