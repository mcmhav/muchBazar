...
\label{par:clothia}
    \begin{chapquote}[30pt]{About Clothia~\cite{clothia}}
        "An online destination where you can mix and match outfits, share looks you love, even try on clothes virtually via your webcam using augmented reality technology"
    \end{chapquote}
    \subparagraph{Strengths} % (fold)
        \begin{itemize}
            \item Users can like items
            \item Users can follow other users
            \item Users can put together sets of items and show to other users
            \item System has most popular list
        \end{itemize}
    % subparagraph strengths (end)
    \subparagraph{Weaknesses} % (fold)
        \begin{itemize}
            \item Lack personalized recommendations
        \end{itemize}
    % subparagraph weaknesses (end)
...
\label{par:trendabl}
    \begin{chapquote}[30pt]{About Trendabl~\cite{trendabl}}
        "Trendabl is a community of people who love fashion"
    \end{chapquote}
    \subparagraph{Strengths} % (fold)
        \begin{itemize}
            \item Users can upload their own fashion items
            \item Users can follow other users
            \item Users can like items
            \item System recommends other users to follow
        \end{itemize}
    % subparagraph strengths (end)
    \subparagraph{Weaknesses} % (fold)
        \begin{itemize}
            \item Recommended users to follow are the top users in the system
        \end{itemize}
