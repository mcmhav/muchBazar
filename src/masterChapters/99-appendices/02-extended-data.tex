...
\chapter{Extended Data}\label{app:req}
    ...
    % The table below presents all the event types in the SoBazaar application.
    ...
    % The table below presents all the metadata in an event in the SoBazaar application with examples.
    ...
    % The next figure is the complete overview of the states in the SoBazaar application and their interactions.
