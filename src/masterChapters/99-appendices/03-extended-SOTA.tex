...
We continue our analysis here started in~\ref{subsec:competitors}.
...
\begin{table}[H]
  ...
  \begin{tabularx}{\linewidth}{>{\parskip1ex}X@{\kern4\tabcolsep}>{\parskip1ex}X}
    ...
    Similar items \par
    &
    Not shown most popular items \par
    Cannot \emph{like} items \par
  ...
  \centering
    ...
    \toprule
      \hfil\bfseries Strengths
        ...
        \hfil\bfseries Weaknesses
        \\\cmidrule(r{3\tabcolsep}){1-1}\cmidrule(l{-\tabcolsep}){2-2}
                Sort items by most trending \par
...
\begin{figure}[H]
    ...
    \includegraphics[scale=0.4]{image/bootstrap.png}
    \centering
