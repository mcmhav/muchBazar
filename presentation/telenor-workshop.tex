...
\begin{document}
  ...
  \begin{frame}
    ...
    \bottomrule\end{tabular}}\caption{Overview of the key figures in the SoBazaar dataset}\end{table}
  \end{frame}
  ...
  \begin{frame}
    \frametitle{SoBazaar Data - Something else}
      ...
      \resizebox*{!}{0.5\textheight}{
          ...
          \caption[Implicit Rating Evaluation]{Overview of how the generated ratings from the implicit feedback can be evaluated.}
        \end{figure}
  \end{frame}
